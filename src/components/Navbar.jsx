      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-20 flex flex-col space-y-8 bg-emerald-950 px-20 pt-20 text-3xl font-bold uppercase text-emerald-100 lg:text-3xl"
          >
            <button
              onClick={() => setIsOpen(false)}
              type="button"
              className="absolute right-4 top-4 rounded-ful
             bg-emerald-950 p-2 text-orange-50 lg:right-20"
            >
